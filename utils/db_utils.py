...
def save_report_to_db(report_data, file_metadata, ai_log):
    ...
    try:
        ...
        report = Report(
            ...
            audit_period_start_date=report_data.audit_period_start_date.date() if report_data.audit_period_start_date else None,
            audit_period_end_date=report_data.audit_period_end_date.date() if report_data.audit_period_end_date else None,
